    ...
    () {
      testWidgets(
        ...
        (tester) async {
          ...
          // Retrieve the username from the HomeScreen
          final usernameFinder = find.text('Welcome, username!');
      ...
      testWidgets(
        ...
        (tester) async {
          ...
          await tester.pumpAndSettle();
          await Future.delayed(const Duration(seconds: 2));
          await tester.enterText(find.byType(TextFormField).at(0), 'chathra');
          await Future.delayed(const Duration(seconds: 2));
          await tester.enterText(find.byType(TextFormField).at(1), 'cha123');
          await Future.delayed(const Duration(seconds: 2));
          await tester.tap(find.byType(ElevatedButton));
          await Future.delayed(const Duration(seconds: 2));
          await tester.pumpAndSettle();
